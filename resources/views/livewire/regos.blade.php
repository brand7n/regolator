<div class="max-w-md mx-auto">
    <div>
        <label for="order" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
            {{ $count }} regos. Sort by:</label>
        <select id="order" name="location" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6" wire:model="order" wire:change="change">
